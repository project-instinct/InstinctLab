...
task_entry = "instinctlab.tasks.HSI.perceptive_downstream_stand.config.g1"

gym.register(
    id="Instinct-HSIDownstreamStand-Perceptive-Shadowing-G1-v0",
...
gym.register(
    id="Instinct-HSIDownstreamStand-Perceptive-Shadowing-G1-Play-v0",
    entry_point="instinctlab.envs:InstinctRlEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Instinct-HSIDownstreamStand-Perceptive-Vae-G1-v0",
    entry_point="instinctlab.envs:InstinctRlEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Instinct-HSIDownstreamStand-Perceptive-Vae-G1-Play-v0",
    entry_point="instinctlab.envs:InstinctRlEnv",
    disable_env_checker=True,
    kwargs={
