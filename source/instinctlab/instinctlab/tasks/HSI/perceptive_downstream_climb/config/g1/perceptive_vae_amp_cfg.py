...
_CLIMB_AMP_SELECTION_YAML = os.path.join(_DATASET_FOLDER, "climb_amp.yaml")
MOTION_NAME = os.path.splitext(os.path.basename(_CLIMB_AMP_SELECTION_YAML))[0]


@configclass
class ClimbAmpMotionCfg(AmassMotionCfgBase):
    path = _DATASET_FOLDER
    retargetting_func = None
    filtered_motion_selection_filepath = _CLIMB_AMP_SELECTION_YAML
